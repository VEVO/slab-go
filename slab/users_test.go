...
func TestUserService_List(t *testing.T) {
	...
	want := &[]User{
		{
			ID: "abc123", Name: "Homer S.", Email: "homer@example.com", Type: "user",
			Title: "Beer belly filler", InsertedAt: insertDate, UpdatedAt: updateDate, Avatar: &Image{},
		},
		{
			ID: "efg456", Name: "Wild dude", Email: "wild@example.com", Type: "user",
			Title: "Bar owner", InsertedAt: insertDate, UpdatedAt: updateDate, Avatar: &Image{},
		},
	}
	expectedResp := `{"data":{"organization":{"users":[
	{
		"type":"user",
		"title":"Beer belly filler",
		"name":"Homer S.",
		...
		"description":"",
		"deactivatedAt":null,
		"avatar":{"thumb":null,"original":null}
	},
	{
		"type":"user",
		"title":"Bar owner",
...
func TestUserService_Get(t *testing.T) {
	...
	expectedResp := `{"data":{"user": {
		"type":"user",
		"title":"Beer belly filler",
		"name":"Homer S.",
		"insertedAt":"2019-05-01T22:44:33.078957Z",
		"updatedAt":"2019-06-18T22:40:16.733422Z",
		"id":"abc123","email":"homer@example.com",
		"description":"",
		"deactivatedAt":null,
		"avatar":{"thumb":null,"original":null}
	}}}`
